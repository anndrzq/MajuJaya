                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body bg-marketplace d-flex">
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-0 mt-2 pt-1 text-muted">The world's first and largest digital marketplace.
                                </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 pt-1">
                                ...
                                <p class="mt-4 mb-0 text-muted"><span class="badge bg-danger-subtle text-danger mb-0 me-1">
                                        <i class="ri-arrow-down-line align-middle"></i> 3.96 % </span> vs. previous
                                    month</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-height-100">
                        <div class="card-body">
                            ...
                            <div class="mt-4 pt-1">
                                ...
                                <p class="mt-4 mb-0 text-muted"><span class="badge bg-success-subtle text-success mb-0">
                                        <i class="ri-arrow-up-line align-middle"></i> 16.24 % </span> vs. previous month
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-xxl-4">
                                    <div class="border-start p-4 h-100 d-flex flex-column">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <p class="text-muted">NFT art is a digital asset that is collectable,
                                                unique, and non-transferrable, Cortes explained Every NFT is unique
                                                duplicated.</p>
                    ...
                    <div class="swiper-slide">
                        <div class="card explore-box card-animate rounded">
                            ...
                            <div class="card-body">
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    8.42k </p>
                                <h5 class="mb-1"><a href="/apps-nft-item-details">Patterns Arts & Culture</a>
                                </h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps-nft-item-details">Long-tailed
                                                        Macaque</a></h6>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps-nft-item-details">Robotic Body
                                                        Art</a></h6>
                                                <p class="text-muted mb-0">Photography</p>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps-nft-item-details">Smillevers
                                                        Crypto</a></h6>
                                                <p class="text-muted mb-0">Artworks</p>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps-nft-item-details">Creative
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mb-1"><a href="/apps-nft-item-details">The
                                                        Chirstoper</a></h6>
