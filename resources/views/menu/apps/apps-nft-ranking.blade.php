...
@push('page-script')
    <script src="{{ asset('') }}assets/js/pages/apps-nft-ranking.init.js"></script>
@endpush
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/nft/img-01.jpg" alt=""
                                                ...
                                                href="/apps-nft-item-details" class="text-body">Abstract Face
                                                Painting</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Patterns Arts &
                                                Culture</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/nft/img-02.jpg" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Creative Filtered
                                                Portrait</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Long-tailed
                                                Macaque</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/nft/img-04.jpg" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Robotic Body Art</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/nft/img-06.jpg" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Smillevers Crypto</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="https://img.themesbrand.com/velzon/images/img-5.gif" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">The Chirstoper</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="https://img.themesbrand.com/velzon/images/img-3.gif" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Walking On Air</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="collection">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/nft/img-04.jpg" alt=""
                                                class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                href="/apps-nft-item-details" class="text-body">Highstreet IHO
                                                Part</a>
                                        </div>
                                    </td>
