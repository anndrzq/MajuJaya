...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="/apps-nft-explore" class="btn btn-soft-primary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="explore-place-bid-img overflow-hidden rounded">
                        ...
                        <div class="place-bid-btn">
                            <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i>
                                Place Bid</a>
                        </div>
                    </div>
                    <div class="mt-3">
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i> 31.64k
                        </p>
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i> 8.34k
                        </p>
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i> 29.20k
                        </p>
        ...
        <div class="col">
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i> 78.34k
                        </p>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="/apps-nft-creators" class="btn btn-soft-primary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <img src="assets/images/nft/img-03.jpg" alt="" class="card-img-top object-fit-cover"
                    height="120">
        ...
        <div class="col">
            <div class="card">
                <img src="assets/images/nft/img-01.jpg" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
