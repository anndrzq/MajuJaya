                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="/apps-tasks-details"
                                            class="d-block">Velzon - Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <ul class="link-inline mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0)" class="text-muted"><i
                                                    class="ri-question-answer-line align-bottom"></i> 32</a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="javascript:void(0)" class="text-muted"><i
                ...
                <div id="todo-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a href="/apps-tasks-details"
                                            class="d-block">Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <p class="text-muted">Sales and marketing are two business functions within an organization.
                            </p>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <p class="text-muted">BrandCrowd's brand logo maker allows you to generate and customize
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="/apps-tasks-details"
                                    class="d-block">Change Old App Icon</a></h6>
                ...
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="/apps-tasks-details"
                                    class="d-block">Create Product Animations</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="/apps-tasks-details"
                                    class="d-block">Product Features Analysis</a></h6>
                            <p class="text-muted">An essential part of strategic planning is running a product feature
                                analysis.</p>
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="/apps-tasks-details"
                                    class="d-block">Create a Graph of Sketch</a></h6>
                            <p class="text-muted">To make a pie chart with equal slices create a perfect circle by
                ...
                <div id="completed-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="/apps-tasks-details"
                                        class="d-block">Create a Blog Template UI</a></h6>
                                <div class="dropdown">
                ...
                <div id="new-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="/apps-tasks-details"
                                    class="d-block">Banner Design for FB & Twitter</a></h6>
                            <div class="tasks-img rounded"
