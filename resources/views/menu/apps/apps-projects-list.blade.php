...
@section('content')
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="/apps-projects-create" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i>
                    Add New</a>
            </div>
        </div>
        <div class="col-sm">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="/apps-projects-overview" class="text-body">Slack brand
                                        logo design</a></h5>
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="/apps-projects-overview" class="text-body">Project
                                        App</a></h5>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="95" aria-valuemin="0"
                                aria-valuemax="100" style="width: 95%;"></div><!-- /.progress-bar -->
                        </div><!-- /.progress -->
                    </div>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="41" aria-valuemin="0"
                                aria-valuemax="100" style="width: 41%;"></div><!-- /.progress-bar -->
                        </div><!-- /.progress -->
                    </div>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="35" aria-valuemin="0"
                                aria-valuemax="100" style="width: 35%;"></div><!-- /.progress-bar -->
                        </div><!-- /.progress -->
                    </div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-14 mb-3"><a href="/apps-projects-overview" class="text-body">Kanban Board</a>
                        </h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="71" aria-valuemin="0"
                                aria-valuemax="100" style="width: 71%;"></div><!-- /.progress-bar -->
                        </div><!-- /.progress -->
                    </div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="/apps-projects-overview" class="text-body">Ecommerce app</a>
                        </h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="20" aria-valuemin="0"
                                aria-valuemax="100" style="width: 20%;"></div><!-- /.progress-bar -->
                        </div><!-- /.progress -->
                    </div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="/apps-projects-overview" class="text-body">Redesign - Landing
                                page</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
                    ...
                    <div>
                        ...
                        <div class="progress progress-sm animated-progress">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="54" aria-valuemin="0"
                                aria-valuemax="100" style="width: 54%;"></div><!-- /.progress-bar -->
                        </div><!-- /.progress -->
                    </div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="/apps-projects-overview" class="text-body">Multipurpose
                                landing template</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
